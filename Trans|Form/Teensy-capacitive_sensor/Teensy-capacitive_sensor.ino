...
const int buttonPin[NButtons] = {15}; //* the number of the pushbutton pins in the desired not order
...
// SMOOTH
AnalogSmooth smoothVal = AnalogSmooth(50);

void setup() {

  //Serial.begin(9600); // use if using with ATmega328 (uno, mega, nano...) - 115200 for Hairless MIDI or 31250 for MIDI class compliant
  Serial.begin(57600); // use if using with ATmega328 (uno, mega, nano...) - 115200 for Hairless MIDI or 31250 for MIDI class compliant
