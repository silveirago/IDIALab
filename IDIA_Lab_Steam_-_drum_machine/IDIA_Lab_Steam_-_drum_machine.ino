...
const int BUTTON_ARDUINO_PIN[N_BUTTONS] = {4, 3, 2, 6, 5}; //* pins of each button connected straigh to the Arduino
...
// LEDS
const byte N_LEDS = 5;
byte ledPin[N_LEDS] = {9, 8, 7, 11, 10};
